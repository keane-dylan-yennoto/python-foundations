...
The program should take the name, price, quantity, and discount percentage of an item from the user 
...
See the problem output in the '1 Store Calculator Challenge.txt'
'''
